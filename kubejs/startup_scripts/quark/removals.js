function removals_Quark() {
    global.REMOVALS.add([
        ...
        /quark:.*(blue_nether|blackstone|netherrack|sandstone)_bricks.*/,
        /quark:.*(crystal_lamp|stool|furnace).*/,
        /quark:.*(duskbound|soul_sandstone|myalite).*/,
        /quark:.*(chorus_twist|chorus_weeds).*/,
        /quark:.*mud.*/,
        /quark:.*shard/,
        'quark:stone_lamp',
    ...
    global.BLOCK_SWAPPER.set('quark:obsidian_pressure_plate', 'minecraft:lightning_rod')
    ...
    */
    ...
    global.BLOCK_SWAPPER.set('quark:limestone_vertical_slab', 'everycomp:q/nomansland/siltstone_vertical_slab')
    ...
    global.BLOCK_SWAPPER.set('quark:polished_limestone_vertical_slab', 'everycomp:q/nomansland/polished_siltstone_vertical_slab')
    ...
    // global.BLOCK_SWAPPER.set('quark:limestone_bricks_vertical_slab', 'everycomp:q/nomansland/siltstone_brick_vertical_slab')
    ...
    global.BLOCK_SWAPPER.set('quark:jasper_vertical_slab', 'everycomp:q/caverns_and_chasms/rhyolite_vertical_slab')
    ...
    global.BLOCK_SWAPPER.set('quark:polished_jasper_vertical_slab', 'everycomp:q/caverns_and_chasms/polished_rhyolite_vertical_slab')
    ...
    // global.BLOCK_SWAPPER.set('quark:jasper_bricks_vertical_slab', 'everycomp:q/caverns_and_chasms/rhyolite_brick_vertical_slab')
    ...
    // global.BLOCK_SWAPPER.set('quark:polished_shale_vertical_slab', 'everycomp:q/caverns_and_chasms:smooth_schist_vertical_slab')
    ...
    // Carpets
    global.BLOCK_SWAPPER.set('quark:red_blossom_leaf_carpet', 'environmental:pink_wisteria_leaf_pile')
    ...
    global.BLOCK_SWAPPER.set('quark:blue_blossom_leaf_carpet', 'environmental:blue_wisteria_leaf_pile')
    global.BLOCK_SWAPPER.set('quark:lavender_blossom_leaf_carpet', 'environmental:purple_wisteria_leaf_pile')
    global.BLOCK_SWAPPER.set('quark:ancient_leaf_carpet', 'environmental:white_wisteria_leaf_pile')
    // Hedges
    global.BLOCK_SWAPPER.set('quark:red_blossom_hedge', 'everycomp:q/environmental/pink_wisteria_hedge')
    ...
    global.BLOCK_SWAPPER.set('quark:blue_blossom_hedge', 'everycomp:q/environmental/blue_wisteria_hedge')
    global.BLOCK_SWAPPER.set('quark:lavender_blossom_hedge', 'everycomp:q/environmental/purple_wisteria_hedge')
    global.BLOCK_SWAPPER.set('quark:ancient_hedge', 'everycomp:q/environmental/white_wisteria_hedge')
    // Saplings
    global.BLOCK_SWAPPER.set('quark:red_blossom_sapling', 'environmental:pink_wisteria_sapling')
    ...
    global.BLOCK_SWAPPER.set('quark:blue_blossom_sapling', 'environmental:blue_wisteria_sapling')
    global.BLOCK_SWAPPER.set('quark:lavender_blossom_sapling', 'environmental:purple_wisteria_sapling')
    global.BLOCK_SWAPPER.set('quark:ancient_sapling', 'environmental:white_wisteria_sapling')
    // Potted Saplings
    global.BLOCK_SWAPPER.set('quark:potted_red_blossom_sapling', 'environmental:potted_pink_wisteria_sapling')
    ...
    global.BLOCK_SWAPPER.set('quark:potted_blue_blossom_sapling', 'environmental:potted_blue_wisteria_sapling')
    global.BLOCK_SWAPPER.set('quark:potted_lavender_blossom_sapling', 'environmental:potted_purple_wisteria_sapling')
    global.BLOCK_SWAPPER.set('quark:potted_ancient_sapling', 'environmental:potted_white_wisteria_sapling')
    // Leaves
    global.BLOCK_SWAPPER.set('quark:red_blossom_leaves', 'environmental:pink_wisteria_leaves')
    ...
    global.BLOCK_SWAPPER.set('quark:blue_blossom_leaves', 'environmental:blue_wisteria_leaves')
    global.BLOCK_SWAPPER.set('quark:lavender_blossom_leaves', 'environmental:purple_wisteria_leaves')
    global.BLOCK_SWAPPER.set('quark:ancient_leaves', 'environmental:white_wisteria_leaves')
